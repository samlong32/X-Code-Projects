...
class TableViewController: UITableViewController {
    var posts: [Post] = [
        ...
        Post(title: "Painting Adventure", bodyText: "Explored acrylic painting techniques today. So much color and creativity!", date: "11/28/23", user: "ArtisticSoul", comments: 9),
